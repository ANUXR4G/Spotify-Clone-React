...
import b1 from '../Assets/b4.jpeg';

const Footer = () => {
  return (
    <div className=' fixed bottom-0 w-full z-10'>
      <div className="bg-[#181818] border-slate-500 border-b p-4 pb-6 sm:p-10 sm:pb-8 lg:p-0 xl:p-4 xl:pb-0 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8 lg:ml-[20%] rounded-lg">
        <div className="flex items-center space-x-4">
          <img src={b1} alt="" width="88" height="88" className="flex-none rounded-lg bg-slate-100" loading="lazy" />
          <div className="min-w-0 flex-auto space-y-1 font-semibold">
            <p className="text-[#16a34a] text-sm leading-6">
              <p>Album : Shikwa</p>
            </p>
            <h2 className="bg-[#181818] text-white text-sm leading-6 truncate">
             Song : Shikwa
            </h2>
        ...
        <div className="space-y-2">
          <div className="relative">
            <div className="bg-slate-700 rounded-full overflow-hidden">
              <div className="bg-[#16a34a] w-1/2 h-2" role="progressbar" aria-label="music progress" aria-valuenow="1456" aria-valuemin="0" aria-valuemax="4550"></div>
            </div>
            <div className="ring-[#16a34a] ring-2 absolute left-1/2 top-1/2 w-4 h-4 -mt-2 -ml-2 flex items-center justify-center bg-[#181818] rounded-full shadow">
              <div className="w-1.5 h-1.5 bg-[#16a34a] rounded-full ring-1 ring-inset ring-slate-900/5"></div>
            </div>
          </div>
          <div className="flex justify-between text-sm leading-6 font-medium tabular-nums">
            <div className="text-slate-100">24:16</div>
            <div className="text-slate-400">75:50</div>
          </div>
        </div>
      </div>
      <div className="bg-[#181818] lg:ml-[20%] text-slate-200 rounded-b-xl flex items-center">
      ...
      <Player/>
        <div className="flex-auto flex items-center justify-evenly">
          ...
          <button type="button" className="rounded-lg text-xs leading-6 font-semibold px-2 ring-inset ring-slate-500 text-slate-100 ring-0 bg-slate-500">
            1x
          </button>
        </div>
      </div>
